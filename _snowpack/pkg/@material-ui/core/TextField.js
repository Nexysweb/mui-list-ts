...
var InputBase = /*#__PURE__*/react.forwardRef(function InputBase(props, ref) {
  ...
  return /*#__PURE__*/react.createElement("div", _extends({
    className: __pika_web_default_export_for_treeshaking__$1(classes.root, classes["color".concat(capitalize(fcs.color || 'primary'))], className, fcs.disabled && classes.disabled, fcs.error && classes.error, fullWidth && classes.fullWidth, fcs.focused && classes.focused, muiFormControl && classes.formControl, multiline && classes.multiline, startAdornment && classes.adornedStart, endAdornment && classes.adornedEnd, fcs.margin === 'dense' && classes.marginDense),
    onClick: handleClick,
    ref: ref
    ...
    className: __pika_web_default_export_for_treeshaking__$1(classes.input, inputPropsProp.className, fcs.disabled && classes.disabled, multiline && classes.inputMultiline, fcs.hiddenLabel && classes.inputHiddenLabel, startAdornment && classes.inputAdornedStart, endAdornment && classes.inputAdornedEnd, type === 'search' && classes.inputTypeSearch, fcs.margin === 'dense' && classes.inputMarginDense),
    onBlur: handleBlur,
    onChange: handleChange,
    onFocus: handleFocus
...
var FilledInput = /*#__PURE__*/react.forwardRef(function FilledInput(props, ref) {
  ...
  return /*#__PURE__*/react.createElement(InputBase$1, _extends({
    classes: _extends({}, classes, {
      root: __pika_web_default_export_for_treeshaking__$1(classes.root, !disableUnderline && classes.underline),
      underline: null
    }),
    fullWidth: fullWidth,
...
var FormHelperText = /*#__PURE__*/react.forwardRef(function FormHelperText(props, ref) {
  ...
  return /*#__PURE__*/react.createElement(Component, _extends({
    className: __pika_web_default_export_for_treeshaking__$1(classes.root, (fcs.variant === 'filled' || fcs.variant === 'outlined') && classes.contained, className, fcs.disabled && classes.disabled, fcs.error && classes.error, fcs.filled && classes.filled, fcs.focused && classes.focused, fcs.required && classes.required, fcs.margin === 'dense' && classes.marginDense),
    ref: ref
  }, other), children === ' ' ?
  /*#__PURE__*/
...
var InputLabel = /*#__PURE__*/react.forwardRef(function InputLabel(props, ref) {
  ...
  return /*#__PURE__*/react.createElement(FormLabel$1, _extends({
    "data-shrink": shrink,
    className: __pika_web_default_export_for_treeshaking__$1(classes.root, className, muiFormControl && classes.formControl, !disableAnimation && classes.animated, shrink && classes.shrink, fcs.margin === 'dense' && classes.marginDense, {
...
var NativeSelectInput = /*#__PURE__*/react.forwardRef(function NativeSelectInput(props, ref) {
  ...
  return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement("select", _extends({
    className: __pika_web_default_export_for_treeshaking__$1(classes.root, // TODO v5: merge root and select
    classes.select, classes[variant], className, disabled && classes.disabled),
    disabled: disabled,
    ref: inputRef || ref
  }, other)), props.multiple ? null : /*#__PURE__*/react.createElement(IconComponent, {
    className: __pika_web_default_export_for_treeshaking__$1(classes.icon, classes["icon".concat(capitalize(variant))], disabled && classes.disabled)
  }));
});
...
var NotchedOutline = /*#__PURE__*/react.forwardRef(function NotchedOutline(props, ref) {
  ...
  if (label !== undefined) {
    return /*#__PURE__*/react.createElement("fieldset", _extends({
      ...
      className: __pika_web_default_export_for_treeshaking__$1(classes.legendLabelled, notched && classes.legendNotched)
...
var NotchedOutline$1 = withStyles(styles$9, {
...
var OutlinedInput = /*#__PURE__*/react.forwardRef(function OutlinedInput(props, ref) {
  ...
  return /*#__PURE__*/react.createElement(InputBase$1, _extends({
    ...
    classes: _extends({}, classes, {
      root: __pika_web_default_export_for_treeshaking__$1(classes.root, classes.underline),
      notchedOutline: null
    }),
    fullWidth: fullWidth,
    inputComponent: inputComponent,
