...
var styles = function styles(theme) {
  var getColor = theme.palette.type === 'light' ? styles$3.darken : styles$3.lighten;
  var getBackgroundColor = theme.palette.type === 'light' ? styles$3.lighten : styles$3.darken;
  return {
...
var Alert$1 = styles$3.withStyles(styles, {
  name: 'MuiAlert'
})(Alert);
  ...
  return {
    ...
    page: {
      ...
      '&$selected': {
        ...
        '&:hover, &$focusVisible': {
          backgroundColor: styles$3.fade(theme.palette.action.selected, theme.palette.action.selectedOpacity + theme.palette.action.hoverOpacity),
          // Reset on touch devices, it doesn't add specificity
          '@media (hover: none)': {
            backgroundColor: theme.palette.action.selected
          }
    ...
    outlinedPrimary: {
      '&$selected': {
        ...
        border: "1px solid ".concat(styles$3.fade(theme.palette.primary.main, 0.5)),
        backgroundColor: styles$3.fade(theme.palette.primary.main, theme.palette.action.activatedOpacity),
        '&:hover, &$focusVisible': {
          backgroundColor: styles$3.fade(theme.palette.primary.main, theme.palette.action.activatedOpacity + theme.palette.action.hoverOpacity),
          // Reset on touch devices, it doesn't add specificity
          '@media (hover: none)': {
            backgroundColor: 'transparent'
          }
    ...
    outlinedSecondary: {
      '&$selected': {
        ...
        border: "1px solid ".concat(styles$3.fade(theme.palette.secondary.main, 0.5)),
        backgroundColor: styles$3.fade(theme.palette.secondary.main, theme.palette.action.activatedOpacity),
        '&:hover, &$focusVisible': {
          backgroundColor: styles$3.fade(theme.palette.secondary.main, theme.palette.action.activatedOpacity + theme.palette.action.hoverOpacity),
          // Reset on touch devices, it doesn't add specificity
          '@media (hover: none)': {
            backgroundColor: 'transparent'
          }
...
var PaginationItem = /*#__PURE__*/react.forwardRef(function PaginationItem(props, ref) {
  ...
  return type === 'start-ellipsis' || type === 'end-ellipsis' ? /*#__PURE__*/react.createElement("div", {
    ref: ref,
    className: __pika_web_default_export_for_treeshaking__(classes.root, classes.ellipsis, disabled && classes.disabled, size !== 'medium' && classes["size".concat(capitalize(size))])
  }, "\u2026") : /*#__PURE__*/react.createElement(ButtonBase, _extends({
    ref: ref,
    component: component,
    disabled: disabled,
    focusVisibleClassName: classes.focusVisible,
    className: __pika_web_default_export_for_treeshaking__(classes.root, classes.page, classes[variant], classes[shape], className, color !== 'standard' && classes["".concat(variant).concat(capitalize(color))], disabled && classes.disabled, selected && classes.selected, size !== 'medium' && classes["size".concat(capitalize(size))])
  }, other), type === 'page' && page, Icon ? /*#__PURE__*/react.createElement(Icon, {
    className: classes.icon
  }) : null);
});
var PaginationItem$1 = styles$3.withStyles(styles$1, {
...
var Pagination$1 = styles$3.withStyles(styles$2, {
  name: 'MuiPagination'
})(Pagination);

export { Alert$1 as Alert, Pagination$1 as Pagination };
